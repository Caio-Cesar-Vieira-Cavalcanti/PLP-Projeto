...
regras =
  "-> O jogador precisará derrotar todos os inimigos, cada um com seu porte, de Pequeno, Médio e/ou Grande, sem esgotar os seus recursos "
    ++ "e muito menos, sem atingir todos os espaços amigos - representados por Civis/Hospitais/Escolas - que se concretizado, o jogador é derrotado por "
    ...
    ++ "todos os inimigos) primeiro que o jogador, leva a vitória. Com o adicional, de que a máquina sofrerá do desafio dos espaços amigos (Perda de Sanidade), "
    ++ "que se atingido todos, o jogador é automaticamente o vitorioso da partida.\n\n"
    ...
    ++ "-> Para cada espaço inimigo derrotado (as partes que o formam por completo) o jogador ganha moedas na proporção do porte "
    ++ "do inimigo, e é contabilizado no mostrador de \"Moedas\" na HUD do jogo.\n\n"
